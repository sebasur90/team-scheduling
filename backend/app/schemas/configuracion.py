...
class ConfiguracionCoberturaUpdate(BaseModel):
    minimo_tipo_a: int = Field(..., ge=0, description="Mínimo requerido para tipo_a")
    minimo_tipo_b: int = Field(..., ge=0, description="Mínimo requerido para tipo_b")


class ConfiguracionCoberturaResponse(BaseModel):
    id: int
    minimo_tipo_a: int
    minimo_tipo_b: int
    created_at: datetime
